#define WBTN_A (WPAD_BUTTON_A | WPAD_CLASSIC_BUTTON_B)
#define WBTN_B (WPAD_BUTTON_B | WPAD_CLASSIC_BUTTON_Y)
#define WBTN_1 (WPAD_BUTTON_1 | WPAD_CLASSIC_BUTTON_X)
#define WBTN_2 (WPAD_BUTTON_2 | WPAD_CLASSIC_BUTTON_A)
...
#define BTN_UP_REPEAT ((btn & WBTN_UP)||(btn & BTN_UP)!=0)
#define BTN_RIGHT_REPEAT ((btn & WBTN_RIGHT)||(btn & BTN_RIGHT)!=0)
#define BTN_DOWN_REPEAT ((btn & WBTN_DOWN)||(btn & BTN_DOWN)!=0)
#define BTN_LEFT_REPEAT ((btn & WBTN_LEFT)||(btn & BTN_LEFT)!=0)
#define BTN_A_REPEAT ((btn & WBTN_A)||(btn & BTN_A)!=0)
#define BTN_B_REPEAT ((btn & WBTN_B)||(btn & BTN_B)!=0)
#define BTN_MINUS_REPEAT ((btn & WBTN_MINUS)||(btn & BTN_MINUS)!=0)
#define BTN_PLUS_REPEAT ((btn & WBTN_PLUS)||(btn & BTN_PLUS)!=0)
#define BTN_HOME_REPEAT ((btn & WBTN_HOME)||(btn & BTN_HOME)!=0)
#define BTN_1_REPEAT ((btn & WBTN_1)||(btn & BTN_1)!=0)
#define BTN_2_REPEAT ((btn & WBTN_2)||(btn & BTN_2)!=0)
