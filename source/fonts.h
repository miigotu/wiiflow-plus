...
#define FONT_BOLD	24u
#define FONT_NOBOLD	6u

#define TITLEFONT_PT_SZ	36u
#define BTNFONT_PT_SZ	18u
#define LBLFONT_PT_SZ	18u
#define THXSFONT_PT_SZ	6u

#define TITLEFONT	TITLEFONT_PT_SZ, TITLEFONT_PT_SZ + 4, FONT_BOLD, 1
#define BUTTONFONT	BTNFONT_PT_SZ, BTNFONT_PT_SZ + 4, FONT_BOLD, 1
#define LABELFONT	LBLFONT_PT_SZ, LBLFONT_PT_SZ + 4, FONT_BOLD, 0
#define THANKSFONT	THXSFONT_PT_SZ, THXSFONT_PT_SZ + 4, FONT_NOBOLD, 0