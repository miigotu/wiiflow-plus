...
#define FONT_NOBOLD	2u

#define TITLEFONT_PT_SZ	36u
#define BTNFONT_PT_SZ	24u
#define LBLFONT_PT_SZ	24u
#define THXSFONT_PT_SZ	8u

#define TITLEFONT	TITLEFONT_PT_SZ, TITLEFONT_PT_SZ, FONT_BOLD, 1
#define BUTTONFONT	BTNFONT_PT_SZ, BTNFONT_PT_SZ, FONT_BOLD, 1
#define LABELFONT	LBLFONT_PT_SZ, LBLFONT_PT_SZ, FONT_BOLD, 1
#define THANKSFONT	THXSFONT_PT_SZ, THXSFONT_PT_SZ, FONT_NOBOLD, 1