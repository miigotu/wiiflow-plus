...
void CMenu::_initConfigScreenMenu(CMenu::SThemeData &theme)
{
	...
	m_configScreenLblTVWidth = _addLabel(theme, "SCREEN/TVWIDTH", 40, 130, 340, 56, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVWidthVal = _addLabel(theme, "SCREEN/TVWIDTH_BTN", 426, 130, 118, 56, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	m_configScreenLblTVHeight = _addLabel(theme, "SCREEN/TVHEIGHT", 40, 190, 340, 56, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVHeightVal = _addLabel(theme, "SCREEN/TVHEIGHT_BTN", 426, 190, 118, 56, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	m_configScreenLblTVX = _addLabel(theme, "SCREEN/TVX", 40, 250, 340, 56, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVXVal = _addLabel(theme, "SCREEN/TVX_BTN", 426, 250, 118, 56, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	...
	m_configScreenLblTVY = _addLabel(theme, "SCREEN/TVY", 40, 310, 340, 56, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	...
	_setHideAnim(m_configScreenLblTVHeight, "SCREEN/TVHEIGHT", 0, 0, 1.f, 0.f);
	...
	_setHideAnim(m_configScreenLblTVX, "SCREEN/TVX", 0, 0, 1.f, 0.f);
	...
	_setHideAnim(m_configScreenLblTVY, "SCREEN/TVY", 0, 0, 1.f, 0.f);
