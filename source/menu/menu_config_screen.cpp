...
{
	_addUserLabels(theme, m_configScreenLblUser, ARRAY_SIZE(m_configScreenLblUser), "CFGSCREEN");
	m_configScreenBg = _texture(theme.texSet, "CFGSCREEN/BG", "texture", theme.bg);
	m_configScreenLblTVWidth = _addLabel(theme, "CFGSCREEN/TVWIDTH", theme.lblFont, L"", 40, 130, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVWidthVal = _addLabel(theme, "CFGSCREEN/TVWIDTH_BTN", theme.btnFont, L"", 426, 130, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	m_configScreenBtnTVWidthM = _addPicButton(theme, "CFGSCREEN/TVWIDTH_MINUS", theme.btnTexMinus, theme.btnTexMinusS, 370, 130, 56, 56);
	m_configScreenBtnTVWidthP = _addPicButton(theme, "CFGSCREEN/TVWIDTH_PLUS", theme.btnTexPlus, theme.btnTexPlusS, 544, 130, 56, 56);
	m_configScreenLblTVHeight = _addLabel(theme, "CFGSCREEN/TVHEIGHT", theme.lblFont, L"", 40, 190, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVHeightVal = _addLabel(theme, "CFGSCREEN/TVHEIGHT_BTN", theme.btnFont, L"", 426, 190, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	m_configScreenBtnTVHeightM = _addPicButton(theme, "CFGSCREEN/TVHEIGHT_MINUS", theme.btnTexMinus, theme.btnTexMinusS, 370, 190, 56, 56);
	m_configScreenBtnTVHeightP = _addPicButton(theme, "CFGSCREEN/TVHEIGHT_PLUS", theme.btnTexPlus, theme.btnTexPlusS, 544, 190, 56, 56);
	m_configScreenLblTVX = _addLabel(theme, "CFGSCREEN/TVX", theme.lblFont, L"", 40, 250, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVXVal = _addLabel(theme, "CFGSCREEN/TVX_BTN", theme.btnFont, L"", 426, 250, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	m_configScreenBtnTVXM = _addPicButton(theme, "CFGSCREEN/TVX_MINUS", theme.btnTexMinus, theme.btnTexMinusS, 370, 250, 56, 56);
	m_configScreenBtnTVXP = _addPicButton(theme, "CFGSCREEN/TVX_PLUS", theme.btnTexPlus, theme.btnTexPlusS, 544, 250, 56, 56);
	m_configScreenLblTVY = _addLabel(theme, "CFGSCREEN/TVY", theme.lblFont, L"", 40, 310, 340, 56, theme.lblFontColor, FTGX_JUSTIFY_LEFT | FTGX_ALIGN_MIDDLE);
	m_configScreenLblTVYVal = _addLabel(theme, "CFGSCREEN/TVY_BTN", theme.btnFont, L"", 426, 310, 118, 56, theme.btnFontColor, FTGX_JUSTIFY_CENTER | FTGX_ALIGN_MIDDLE, theme.btnTexC);
	m_configScreenBtnTVYM = _addPicButton(theme, "CFGSCREEN/TVY_MINUS", theme.btnTexMinus, theme.btnTexMinusS, 370, 310, 56, 56);
	m_configScreenBtnTVYP = _addPicButton(theme, "CFGSCREEN/TVY_PLUS", theme.btnTexPlus, theme.btnTexPlusS, 544, 310, 56, 56);
	// 
	_setHideAnim(m_configScreenLblTVWidth, "CFGSCREEN/TVWIDTH", 100, 0, -2.f, 0.f);
	_setHideAnim(m_configScreenLblTVWidthVal, "CFGSCREEN/TVWIDTH_BTN", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVWidthM, "CFGSCREEN/TVWIDTH_MINUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVWidthP, "CFGSCREEN/TVWIDTH_PLUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenLblTVHeight, "CFGSCREEN/TVHEIGHT", 100, 0, -2.f, 0.f);
	_setHideAnim(m_configScreenLblTVHeightVal, "CFGSCREEN/TVHEIGHT_BTN", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVHeightM, "CFGSCREEN/TVHEIGHT_MINUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVHeightP, "CFGSCREEN/TVHEIGHT_PLUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenLblTVX, "CFGSCREEN/TVX", 100, 0, -2.f, 0.f);
	_setHideAnim(m_configScreenLblTVXVal, "CFGSCREEN/TVX_BTN", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVXM, "CFGSCREEN/TVX_MINUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVXP, "CFGSCREEN/TVX_PLUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenLblTVY, "CFGSCREEN/TVY", 100, 0, -2.f, 0.f);
	_setHideAnim(m_configScreenLblTVYVal, "CFGSCREEN/TVY_BTN", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVYM, "CFGSCREEN/TVY_MINUS", 0, 0, 1.f, -1.f);
	_setHideAnim(m_configScreenBtnTVYP, "CFGSCREEN/TVY_PLUS", 0, 0, 1.f, -1.f);
